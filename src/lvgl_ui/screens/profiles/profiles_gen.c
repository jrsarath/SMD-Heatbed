...
lv_obj_t * profiles_create(void)
{
    ...
    if (lvgl_ui_check_target(LVGL_UI_TARGET_ALL)) {
        ...
        lv_obj_set_style_border_color(lv_obj_3, COLOR_ACCENT, 0);
        ...
        lv_label_set_text(lv_label_2, "SAC305 (Lead-Free)");
        lv_obj_set_style_text_color(lv_label_2, COLOR_TEXT_PRIMARY, 0);
        lv_obj_set_style_text_font(lv_label_2, font_md, 0);

        lv_obj_t * lv_label_3 = lv_label_create(lv_obj_4);
        lv_label_set_text(lv_label_3, "SELECTED");
        ...
        lv_label_set_text(lv_label_4, "Preheat: 150°C | Soak: 180°C | Peak: 245°C");
        ...
        lv_label_set_text(lv_label_5, "Sn63 / Pb37 (Leaded)");
        lv_obj_set_style_text_color(lv_label_5, COLOR_TEXT_PRIMARY, 0);
        lv_obj_set_style_text_font(lv_label_5, font_md, 0);

        lv_obj_t * lv_label_6 = lv_label_create(lv_obj_5);
        lv_label_set_text(lv_label_6, "Preheat: 140°C | Soak: 165°C | Peak: 215°C");
        ...
        lv_obj_set_style_border_color(lv_obj_6, COLOR_CARD_BORDER, 0);
        lv_obj_set_style_radius(lv_obj_6, RADIUS_MD, 0);
        lv_obj_set_style_pad_all(lv_obj_6, SPACE_SM, 0);
        lv_obj_set_style_pad_gap(lv_obj_6, SPACE_XS, 0);
        lv_obj_t * lv_label_7 = lv_label_create(lv_obj_6);
        lv_label_set_text(lv_label_7, "Sn42 / Bi58 (Low-Temp)");
        lv_obj_set_style_text_color(lv_label_7, COLOR_TEXT_PRIMARY, 0);
        lv_obj_set_style_text_font(lv_label_7, font_md, 0);

        lv_obj_t * lv_label_8 = lv_label_create(lv_obj_6);
        lv_label_set_text(lv_label_8, "Preheat: 90°C | Soak: 130°C | Peak: 165°C");
        ...
        lv_obj_set_style_pad_all(lv_obj_7, SPACE_SM, 0);
        lv_obj_set_style_pad_gap(lv_obj_7, SPACE_XS, 0);
        lv_obj_t * lv_label_9 = lv_label_create(lv_obj_7);
        lv_label_set_text(lv_label_9, "Constant Preheat Mode");
        lv_obj_set_style_text_color(lv_label_9, COLOR_TEXT_PRIMARY, 0);
        lv_obj_set_style_text_font(lv_label_9, font_md, 0);

        lv_obj_t * lv_label_10 = lv_label_create(lv_obj_7);
        lv_label_set_text(lv_label_10, "Constant Hold: 150°C (Indefinite)");
