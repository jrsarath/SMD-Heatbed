...
lv_obj_t * navigation_button_create(lv_obj_t * parent, const char * label, bool active, int32_t grow)
{
    ...
    if (!style_inited) {
        ...
        lv_style_set_radius(&style_nav_btn, 4);
        ...
        lv_style_set_text_color(&style_nav_btn, COLOR_NAV_TEXT);
        ...
        lv_style_set_radius(&style_nav_btn_active, 4);
        lv_style_set_bg_color(&style_nav_btn_pressed, COLOR_ACCENT_PRESSED);
        lv_style_set_bg_opa(&style_nav_btn_pressed, (255 * 100 / 100));
        lv_style_set_text_align(&style_nav_btn_label, LV_TEXT_ALIGN_CENTER);
        lv_style_set_align(&style_nav_btn_label, LV_ALIGN_CENTER);
        lv_style_set_text_font(&style_nav_btn_label, font_sm);
